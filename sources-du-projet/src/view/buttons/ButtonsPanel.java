...
public class ButtonsPanel extends HBox {
	...
	public ButtonsPanel(Canva canva) {
		...
		this.buttons_rotation = ButtonsFactory.makeButton("Rotation", canva.getFigure());
		this.buttons_translation = ButtonsFactory.makeButton("Translation", canva.getFigure());
		this.buttons_zoom = ButtonsFactory.makeButton("Zoom", canva.getFigure());
